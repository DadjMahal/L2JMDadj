...
- [ ] **P3** Fix `TASKS.md` (dedup 59–63 collision, renumber, add Evidence col, downgrade `assertTrue(true)` tasks) ← IN PROGRESS
- [ ] **P4** Consolidate rules → `Documentation/WORKFLOW.md`; trim `REQUIREMENTS.md`
