...
(cd "$ENGINE" && nohup timeout 60 bash -c 'java -cp target/classes com.aiplayer.examples.TradeProbe ai_combat_01 ai123pass 127.0.0.1 7777' > /tmp/trade_probe.out 2>&1 &)
sleep 26
