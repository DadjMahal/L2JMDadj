...
| **Audit / deep review (read this FIRST)** | **`Documentation/AUDIT_ORIENTATION.md`** (4-min core map), then `Documentation/DONE_SUMMARY.md` (what's done + reviewer-verified claims), `STATUS.md`, `Documentation/Streams.md`, `Documentation/StreamGDisposition.md` |
