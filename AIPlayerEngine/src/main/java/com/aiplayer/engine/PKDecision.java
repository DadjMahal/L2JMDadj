...
public class PKDecision {
    ...
    public static void main(String[] args) {
        ...
        LOGGER.info("Good vs Evil: " + makeDecision(bot1, bot2));
        LOGGER.info("Safe zone: " + makeDecision(bot1, bot3));
        LOGGER.info("Evil vs Protected: " + makeDecision(bot2, new PKBot(-5000, false, true, 200, 200)));
    }
}
