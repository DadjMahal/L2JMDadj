...
public class AIPlayerEngine {
    ...
    public void start() {
        ...
        // TODO: Connect to server and spawn AI players
    ...
    public static void main(String[] args) {
        try {
            ...
            // Print usage info
            System.out.println("\n========================================");
            System.out.println("  AI Player Engine Ready!");
            System.out.println("========================================");
            System.out.println("Connected AI Players: " + AIPlayerManager.getInstance().getAIPlayerCount());
            System.out.println("\nAvailable spawn commands:");
            System.out.println("  AIPlayerManager.getInstance().spawnAIPlayer(name, accountId, classId, race, charId)");
            System.out.println("  AIPlayerManager.getInstance().spawnCombatPlayer()");
            System.out.println("  AIPlayerManager.getInstance().spawnQuestPlayer()");
            System.out.println("  AIPlayerManager.getInstance().spawnMerchantPlayer()");
            System.out.println("========================================\n");
    ...
    private static void spawnDefaultAIPlayers() {
        ...
        System.out.println("Spawned 24 AI Players (Combat:6, Quest:6, Merchant:6, Social:6)");
    }
}