 ...
 */
public final class Phase0Integration
{
    private static final Logger LOGGER = Logger.getLogger(Phase0Integration.class.getName());

    private final Phase0Config cfg = Phase0Config.getInstance();
    ...
    public Phase0Integration(AIPlayer aiPlayer)
    {
