...
/** MODE: COMPLETE. Field aliases added for behavior integration (objId, hpMax, hpCurrent, hpPercent, isCritical, distanceTo, classId already present). */
...
public final class PartyMemberInfo {
    ...
    // === Field aliases for behavior code compatibility ===
