 ...
 * from the guide map ({@link com.aiplayer.knowledge.RaceGuide#idleAnchor}) rather than a
...
import com.aiplayer.knowledge.HuntZone;
...
public final class RelocationPlanner
{
    ...
    {
        for (com.aiplayer.knowledge.HuntZone z
