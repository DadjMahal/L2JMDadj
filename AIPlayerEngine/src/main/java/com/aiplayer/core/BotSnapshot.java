 ...
 * whatever already imports it) — new behavior modules should read from
 * BotSnapshot instead of GameStateMirror going forward. See
 * INTEGRATION_GAPS.md for which existing behavior files still need migrating.
 */
public final class BotSnapshot {
    ...
    //     no need to hand-compute this the way earlier earlier patches did ---
