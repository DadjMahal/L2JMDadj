...
/** MODE: COMPLETE. Fields added per PATCH_GameStateMirror.txt (Task 2), PATCH_GameStateMirror_Task3.txt (Task 3), and PATCH_GameStateMirror_level_field.txt (Task 5-11 level field). All phase0 field requirements covered. */
 ...
 * BotSnapshot and phase0 modules read from here instead of using mock data.
 *
