...
## Phase: 2 — Combat AI (live PvE + PvP + quest + movement PROVEN; B7 trade IN PROGRESS)
## Last completed: B8 — live movement proof (MoveProbe): sent MoveToLocation(0x01) from Silvia's spot to (-82515,241221,-3728); server broadcast 17x CHAR_MOVE_TO_LOCATION + VALIDATE_LOCATION and DB characters.x/y/z changed from (-83789,240799,-3717) to exactly (-82515,241221,-3728) (Audit/39)
