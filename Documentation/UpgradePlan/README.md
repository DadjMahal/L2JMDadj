...
Wave 2 (structure):
  EP-2..EP-6 renames/merges         GK-2..GK-5 extractors (npc/quest/item/spawn)
...
Wave 4 (proof):
  RS-5 100-bot soak, RS-6 500-bot profile, final doc sync
```

Rule of thumb: **EP-* and GK-* first** (they change the terrain everything else stands on),
**LW-* interleaves freely**, **IN-* and RS-* build on both**.
