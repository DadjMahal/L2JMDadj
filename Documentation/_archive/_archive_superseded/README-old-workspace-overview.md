> **⚙️ ARCHIVED 2026-08-12** — stale workspace overview (expected `L2JMobiusServers/`, `~/L2JM/`, ant),
> pre-dating the current repo layout. Superseded by the canonical **root `README.md`** (project / web
> panel / API / ops) and the slim `Documentation/README.md` index. Kept for traceability;
