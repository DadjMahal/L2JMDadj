...
| EB-12 | Logging hygiene: core/Logging JUL convention + CompactFormatter, check_style System.out scan widened to whole tree (markers exempt) (502 tests) | DONE-PUSHED 2d274bac |
| EB-13 | PerBotLimiter sliding-window backpressure at CoreWiring.send funnel (20/s cap, revive/exempt, [rate-guard] log) (509 tests) | DONE-PUSHED 83021991 |
...
| GK-8 | GearGuide recommender: class-name weapon line + level grade band + buylist-sold filter + 4/5-purse budget + chain firstClass gate; RestockPlanner drops 2375 placeholder; PlayContext +classId/+adena wired from CharSelectInfo/getAdena (591/591) | DONE-PUSHED 31760085 |
| GK-12 | verify_live.py live-verification job: 6 deterministic JSON↔datapack re-samples (npc 20223, item 1, trainer 30010, teleport 30006, quest 6, class-0 skills) all PASS + best-effort gameserver DB fleet check (honest SKIP w/o creds) | DONE-PUSHED 3a0cc836 |
